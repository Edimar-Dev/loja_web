...
-- Copiando estrutura do banco de dados para loja_web
...
-- Copiando estrutura para tabela loja_web.clientes
...
-- Copiando dados para a tabela loja_web.clientes: ~3 rows (aproximadamente)
